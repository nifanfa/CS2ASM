...
namespace CS2ASM.AMD64
{
    public static class CStage
    {
        ...
        {
            Utility.Start(@"Amd64\7z.exe", $@"e {Environment.CurrentDirectory.Replace(@"\CS2ASM\bin\Debug\netcoreapp3.1", "")}\x64\Debug\{fileNameNoExtensionNameAndPath}.lib -o{Environment.CurrentDirectory}\Amd64\ *.obj -r -y");
